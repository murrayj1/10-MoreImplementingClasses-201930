...
class Line(object):
    ...
    def clone(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        line2 = Line(self.start.clone(), self.end.clone())
        self.clone_num = self.clone_num + 1
       # if (hasattr(self,'clone_num')):
        #    self.clone_num = self.clone_num + 1
       # else:
        #    self.clone_num = 1
        return line2
    ...
    def line_plus(self, other_line):
        ...
        e = other_line.start.x
        f = other_line.start.y
        g = other_line.end.x
        h = other_line.end.y

        line_new = Line(Point(a+e, b+f), Point(c+g, d+h))
        return line_new
